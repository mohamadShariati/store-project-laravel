                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6 col-12 col-sm-6">
                                <div class="slider-single-img slider-animated-1">
                                    <img class="animated" src="{{ asset('/upload/files/banners/images/' . $slider->image) }}" alt="{{ $slider->image }}" />
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row">
                    ...
                    <div class="col-lg-4 col-md-4">
                        <div class="single-banner mb-30 scroll-zoom">
                            <a href="product-details.html">
                                <img class="animated" src="{{ asset('/upload/files/banners/images/' . $banner->image) }}"
                                    alt="" />
                                </a>
                ...
                @foreach ($indexTopBanners->chunk(3)->last() as $banner)
                    <div class="col-lg-6 col-md-6">
                        <div class="single-banner mb-30 scroll-zoom">
                            <a href="product-details.html"><img class="animated" src="{{ asset('/upload/files/banners/images/' . $banner->image) }}"
                                    alt="" /></a>
            ...
            <div class="row">
                @foreach ($indexBottomBanners as $banner)
                    <div class="col-lg-6 col-md-6 text-right">
                        <div class="single-banner mb-30 scroll-zoom">
                            <a href="product-details.html"><img src="{{ asset('/upload/files/banners/images/' . $banner->image) }}" alt="" /></a>
