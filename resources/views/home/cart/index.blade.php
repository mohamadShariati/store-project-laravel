                                        ...
                                        @foreach ($carts as $key => $cart)
                                            <tr>
                                                <td class="product-thumbnail">
                                                    <a
                                                        href="{{ route('home.products.show', $cart->associatedModel->slug) }}"><img
                                                            width="171px"
                                                            src="{{ asset('/upload/files/products/images/' . $cart->associatedModel->primary_image) }}"
                                                            alt=""></a>
                                                </td>
                                                <td class="product-name"><a
                                                        href="{{ route('home.products.show', $cart->associatedModel->slug) }}">{{ $cart->associatedModel->name }}</a>
