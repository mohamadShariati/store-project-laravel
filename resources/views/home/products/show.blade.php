            ...
            <div class="col-lg-6 col-md-6 order-1 order-sm-1 order-md-2">
                <div class="product-details-img">
                    <div class="zoompro-border zoompro-span">
                        <img class="zoompro" src="{{ asset('/upload/files/products/images/' . $product->primary_image) }}"
                            data-zoom-image="{{ asset('/upload/files/products/images/' . $product->primary_image) }}" alt="" />

                    </div>
                    <div id="gallery" class="mt-20 product-dec-slider">
                        <a data-image="{{ asset('/upload/files/products/images/' . $product->primary_image) }}"
                            data-zoom-image="{{ asset('/upload/files/products/images/' . $product->primary_image) }}">
                            <img width="90" src="{{ asset('/upload/files/products/images/'. $product->primary_image) }}" alt="">
                        </a>
                        @foreach ($product->images as $image)
                        <a data-image="{{ asset('/upload/files/products/images/' . $image->image) }}"
                            data-zoom-image="{{ asset('/upload/files/products/images/' . $image->image) }}">
                            <img width="90" src="{{ asset('/upload/files/products/images/' . $image->image) }}" alt="">
                        </a>
                        @endforeach
                    </div>
                </div>
